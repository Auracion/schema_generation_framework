...
data_out='gendata/eq_affected_'${dataset}'/'${dataset}'.json'
table_out='gendata/eq_affected_'${dataset}'/tables.json'
proc_data='gendata/eq_affected_'${dataset}'/'${dataset}'.bin'
proc_table='gendata/eq_affected_'${dataset}'/tables.bin'
output_path='gendata/eq_affected_'${dataset}'/'${dataset}'.rgatsql.bin'
lge_output_path='gendata/eq_affected_'${dataset}'/'${dataset}'.lgesql.bin'


echo 'Generate affected data for '${dataset}' set'
