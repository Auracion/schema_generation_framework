...
data_out='gendata/aug_affected_train/train.json'
table_out='gendata/aug_affected_train/tables.json'
proc_data='gendata/aug_affected_train/train.bin'
proc_table='gendata/aug_affected_train/tables.bin'
output_path='gendata/aug_affected_train/train.rgatsql.bin'
...
echo 'Generate affected data for train set augmentation'
