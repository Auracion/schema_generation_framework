...
from eval.spider.process_sql import tokenize, get_schema, get_tables_with_alias, Schema, get_sql
...
def evaluate(gold, predict, db_dir, etype, kmaps, schemas=None):
    with open(gold) as f:
    ...
    return scores['all']['exec'], scores['all']['exact']
...
if __name__ == "__main__":
    ...
    print(kmaps['department_management'])
